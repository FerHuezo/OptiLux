...
const Footer = () => {
  return (
    <footer className="footer">
      ...
      <div className="social-icons flex justify-center items-center gap-1">          <a href="#"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/2023_Facebook_icon.svg/2048px-2023_Facebook_icon.svg.png" alt="Facebook" /></a>
